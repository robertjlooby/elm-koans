...
testSuite = Test.suite "About Lists" [
              ...
              Test.test "head returns the first item in a list" (assertEqual (Just xNum) (List.head [1, 2, 3])),
              Test.test "minimum returns the minimum of a list of comparables" (assertEqual (Just xNum) (List.minimum [1, 2, 3])),
              Test.test "maximum returns the maximum of a list of comparables" (assertEqual (Just xChar) (List.maximum ['a', 'b', 'c'])),
